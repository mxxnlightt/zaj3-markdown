...
<h4>
    <ol>
        ...
        <li><a href="x">Wymagania systemowe</a></li>
        <li><a href="x">Instalacja</a></li>
        <li><a href="x">Struktura katalagów</a></li>
        <li><a href="x">API - Endpoints</a></li>
        <li><a href="x">Konfiguracja środowiska</a></li>
        <li><a href="x">Tabela testów</a></li>
...
<ul>
    <li>prezentacja działania podstawowego API,
    <li>wykorzystanie lokalnego serwera deweloperskiego,</li>
    <li>demonstracja struktury projektowej,</li>
...
<h4>
    ...
    <ul>
        <li>HTML5</li>
        <li>CSS3 (BEM, zmienne CSS)</li>
        <li>JavaScript ES2022</li>
        <li>Node.js <b>v18.12.1</b></li>
        <li>npm <b>8.19.3</b></li>
    </ul>
    <b>Build tools:</b>
    <ul>
